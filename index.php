<?php
  ...
  $curlHandle = curl_init("https://api.project-ginsberg.com/users/".$resultObject->uid);
  ...
  $curlHandle = curl_init("https://api.project-ginsberg.com/obj-fitness?{\"uid\":\"".$resultObject->uid."\"}");
  ...
  $curlHandle = curl_init("https://api.project-ginsberg.com/obj-fitness");
